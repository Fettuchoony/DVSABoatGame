...
public class DepthNormalsFeature : ScriptableRendererFeature
{
    class DepthNormalsPass : ScriptableRenderPass
    {
        ...
        {
            cmd.GetTemporaryRT(depthAttachmentHandle.GetInstanceID(), descriptor, FilterMode.Point);
            // ConfigureTarget(depthAttachmentHandle.GetInstanceID());
        ...
        public override void FrameCleanup(CommandBuffer cmd)
        {
            ...
            // {
            //     cmd.ReleaseTemporaryRT(depthAttachmentHandle.nameID);
